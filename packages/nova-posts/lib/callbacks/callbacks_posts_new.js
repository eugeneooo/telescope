...
function PostsNewIncrementPostCount (post) {
  ...
  Users.update({_id: userId}, {$inc: {[`${Users.prefix}postCount`]: 1}});
}
...
function PostsNewNotifications (post) {
  ...
  if (typeof Telescope.notifications !== "undefined") {
    ...
    var notifiedUserIds = _.pluck(Users.find({[`${Users.prefix}notifications_posts`]: true}, {fields: {_id:1}}).fetch(), '_id');
